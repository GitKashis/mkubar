...
//        assertEquals(4282125l, Juniorlab.upsidedown(example01, example02));
        assertEquals(3l, Juniorlab.upsidedown(example11, example12));
        assertEquals(2l, Juniorlab.upsidedown(example21, example22));
        assertEquals(4l, Juniorlab.upsidedown(example31, example32));
        assertEquals(12l, Juniorlab.upsidedown(example41, example42));
//        assertEquals(718650l, Juniorlab.upsidedown(example51, example52));
//        assertEquals(78120000l, Juniorlab.upsidedown(example61, example62));
...
//        assertEquals(1789100l, Juniorlab.upsidedown(example111, example112));
        System.out.println(Juniorlab.symmetry("69"));
    }
}